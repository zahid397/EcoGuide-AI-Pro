...
def render_main_content(agent, rag):
    ...
    # -------------------------------------
        ...
        if c2.button("🎉 More Fun"):
            refinement_query = "Add more exciting & high-rated activities."

        if c3.button("😌 More Relax"):
            refinement_query = "Add more relaxing and slow-paced experiences."

        if c4.button("🌿 More Eco"):
            refinement_query = "Increase eco-friendliness of the itinerary."
